    ...
    return (
        <View style={styles.container}>
            ...
            <Animatable.View delay={600} animation="fadeInUp" style={styles.containerForm}>
                ...
                <TouchableOpacity style={styles.buttonFarm} onPress={ () => navigation.navigate('SignInF')}>
                    <Text style={styles.buttonTextFarm}>Farmácia</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.buttonUser} onPress={ () => navigation.navigate('SignInU')}>
